...
class Status {
  ...
  Status.fromJson(Map<String, dynamic> json) {
    ...
    reblog =
        json['reblog'] != null ? new Status.fromJson(json['reblog']) : null;
...
class ClientInfo {
  ...
  static ClientInfo fromSharedPreferences(
    ...
    if (encoded != null) {
      final Map<String, Object> json = JSON.decode(encoded);

      clientInfo = new ClientInfo(json['instance_name'], json['client_id'],
          json['client_secret'], json['access_token']);
    }
    return clientInfo;
  }
